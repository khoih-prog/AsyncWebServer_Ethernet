/****************************************************************************************************************************
  AsyncWebServer_Ethernet.hpp - Dead simple AsyncWebServer for ESP8266 using W5x00/ENC8266 Ethernet
...
#define ASYNC_WEBSERVER_ETHERNET_VERSION           "AsyncWebServer_Ethernet v1.4.1"

#define ASYNC_WEBSERVER_ETHERNET_VERSION_MAJOR     1
#define ASYNC_WEBSERVER_ETHERNET_VERSION_MINOR     4
#define ASYNC_WEBSERVER_ETHERNET_VERSION_PATCH     1

#define ASYNC_WEBSERVER_ETHERNET_VERSION_INT       1004001
...
#ifndef AWS_ETHERNET_UNUSED
  #define AWS_ETHERNET_UNUSED(x) (void)(x)
#endif
...
#include "StringArray_Ethernet.h"
...
#endif /* _ASYNC_WEBSERVER_ETHERNET_HPP_ */
